                    ...
                    <div class="card shadow border-0 p-5">
                        ...
                        <form action="{{ route('account.authenticate') }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{ old('email') }}" type="text" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="example@example.com">
                                @error('email')
...
@section('customjs')
    <script type="text/javascript">
        // Password field visiabality code
